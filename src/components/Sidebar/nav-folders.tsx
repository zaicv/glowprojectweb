            ...
            <CollapsibleContent>
              <SidebarMenuSub>
                ...
                {pinnedThreads.length > 0 && (
                  <>
                    <SidebarMenuSubItem>
                      <div className="px-2 pt-2 pb-1 text-[10px] uppercase tracking-wider text-white/50 font-medium">
                        Pinned
                      </div>
                    </SidebarMenuSubItem>
                        ...
                        <div className="group/thread relative">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent
                              side="right"
                              align="start"
                              className="w-44 rounded-lg bg-black/95 backdrop-blur-xl border-white/10 text-white"
                            >
                              <DropdownMenuLabel>
                                Move to folder
                              </DropdownMenuLabel>
                        ...
                        <div className="flex items-center">
                          ...
                          {editingFolderId === folder.id ? (
                            <Input
                              ...
                              className="flex-1 h-6 text-sm bg-transparent border-none p-0 focus-visible:ring-0 text-white"
                              autoFocus
                            />
                          ) : (
                            <div className="flex-1 min-w-0 flex items-center gap-2">
                              ...
                              <Badge
                                variant="secondary"
                                className="text-xs h-4 px-1.5 bg-white/10 text-white/70"
                              >
